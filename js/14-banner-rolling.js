...
!function (global, $) {
    ...
    JUI.slider = function (selector, options) {
        ...
        function setting() {
            ...
            detect.$listBox      = container.find('.gallery-list'); // div.slider01 > ul.gallery-list
            detect.$lists        = detect.$listBox.children('li'); // div.slider01 > ul.gallery-list > li
            detect.width         = detect.$listBox.width();
            detect.$indicate     = container.find('.ctrl-box a'); // div.ctrl-box > a
